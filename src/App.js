...
export default function SwordDotaznik() {
  ...
  <BarChart data={averageResults}>
    ...
    <Bar dataKey="score">
      {averageResults.map((entry, index) => (
        ...
        <div className="mt-20 p-4 border rounded bg-gray-50 text-center">
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-10 text-center mt-12">SWORD DOTAZNÍK - Reflexe pracovního prostředí</h1>
